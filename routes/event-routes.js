...
const { fetchVenues, createVenue, updateVenue, deleteVenue, fetchEvents, createEvent, updateEvent, deleteEvent, register, fetchEventUsers } = require("../controllers/event-controller");
